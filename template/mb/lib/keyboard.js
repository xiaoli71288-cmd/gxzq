...
;(function(exports){
	var KeyBoard = function(input, options){
		...
		var height = options && options.height || '218px';
		...
		cssStr += '#' + TABLE_ID + '{text-align:center;width:100%;height:186px;border-top:1px solid #CECDCE;background-color:#FFF;}';
		cssStr += '#' + TABLE_ID + ' td{width:33%;border:1px solid #e3e3e3;color:#666;border-right:0;border-top:0;}';
		if(!mobile){
		...
		//Button
		var btnStr = '<div style="width:60px;height:28px;background-color:#598bf6;';
